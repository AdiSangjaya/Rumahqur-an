                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" value="Pra Tahsin 1" class="form-check-input kelas"
                                name="optradio">Tahfidz Anak
                            <br>
                            <i>(syarat : umur minimal 3,5 thn - 12 thn ber komitmen dalam menghafal Al qur'an)</i>
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" value="Pra Tahsin 2" class="form-check-input kelas" name="kelas">Tahfidz
                            Dewasa<br>
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" value="Tahsin Khusus" class="form-check-input kelas" name="kelas">Pra
                            Tahsin Anak<br>
                            <i>(Syarat: Belum bisa membaca sama sekali dan masih iqra)</i>
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" value="Tahsin Remaja/Anak" class="form-check-input kelas"
                                name="kelas">Pra Tahsin Anak
                            <br>
                            <i>(Syarat: Belum bisa membaca sama sekali dan masih iqra)</i>
                        </label>
                    </div>
